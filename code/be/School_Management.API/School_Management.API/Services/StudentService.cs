...
namespace School_Management.API.Services
{
    public class StudentService : IStudentService
    {
        ...
        public StudentService(IStudentRepository studentRepository, UserManager<AppUser> userManager, ApplicationDbContext context, Cloudinary cloudinary, ILogger<StudentService> logger)
        {
