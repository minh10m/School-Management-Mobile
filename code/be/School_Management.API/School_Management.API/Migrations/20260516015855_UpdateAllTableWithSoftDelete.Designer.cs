...
namespace School_Management.API.Migrations
{
    ...
    [Migration("20260516015855_UpdateAllTableWithSoftDelete")]
    partial class UpdateAllTableWithSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.AIChatHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.KnowledgeBase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "IsPopup", "CreatedAt");

                    b.ToTable("Notification", t =>
                        {
                            t.HasCheckConstraint("CK_SchoolYear_Notification", "\"SchoolYear\" >= 2000 AND \"SchoolYear\" < 2100");
                        });
                });
                    ...
                    b.ToTable("Result", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Type_Result", "\"Type\" IN ('Miệng', '15 phút', 'Giữa kì', 'Cuối kì')");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.UserConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("School_Management.API.Models.Domain.Message", b =>
                {
                    b.HasOne("School_Management.API.Models.Domain.Conversation", "Conversation")
                        .WithMany("Messages")
