          ...
          <View className="mt-4">
            ...
            <View className="px-6 py-4 mt-2">
              ...
              {subjectLoading && assignedSubjects.length === 0 ? (
                ...
                >
                  Chưa phân công môn học
                </Text>
              ) : (
                <View className="flex-row flex-wrap gap-2">
                  {assignedSubjects.map((sub) => (
                    <View
                      key={sub.teacherSubjectId}
                      className="bg-purple-50 border border-purple-100 rounded-xl px-3 py-2 flex-row items-center"
                    >
                      <Text
                        style={{
      ...
      >
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-white rounded-t-[40px] h-[60%] p-6">
            ...
            <FlatList
              data={allSubjects.filter(
                (sub) =>
                  !assignedSubjects.some((a) => a.subjectId === sub.subjectId),
              )}
              ...
              ListEmptyComponent={
                <View className="items-center py-10">
                  <Text
                    ...
                    className="text-gray-400"
                  >
                    Tất cả môn học đã được phân công
                  </Text>
                </View>
              }
            />
