        ...
        { text: "Hủy", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              const lockoutEnd = nextLocked
                ? new Date("2099-12-31").toISOString()
                : null;
              await userService.updateStatus(user.userId, { lockoutEnd });
              Alert.alert(
                "Thành công",
                `Đã ${nextLocked ? "khóa" : "mở khóa"} tài khoản.`,
              );
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white mx-4 mt-4 rounded-3xl p-5 border border-gray-100 items-center">
          ...
          <Text
            ...
            className="text-black text-xl mb-1 text-center"
          >
            {user.fullName}
          </Text>
          <View
        ...
        <View className="bg-white mx-4 mt-3 rounded-2xl px-4 border border-gray-100">
          ...
          <InfoRow
            ...
            label="Ngày sinh"
            value={
              user.birthday ? user.birthday.split("T")[0] : "Chưa cập nhật"
            }
          />
          <InfoRow
            icon="person-outline"
        ...
        <View className="mx-4 mt-3 gap-2 pb-10">
          <Text
            style={{ fontFamily: "Poppins-SemiBold" }}
            className="text-gray-500 text-xs mb-1 px-1"
          >
            HÀNH ĐỘNG
          </Text>
          ...
          >
            <View
              className={`w-9 h-9 rounded-full items-center justify-center ${isLocked ? "bg-green-100" : "bg-orange-50"}`}
            >
              <Ionicons
