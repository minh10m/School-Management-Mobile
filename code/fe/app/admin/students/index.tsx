            ...
            <ScrollView showsVerticalScrollIndicator={false} className="mb-10">
              ...
              <View className="mb-12">
                ...
                <View className="flex-row flex-wrap gap-2">
                  ...
                  >
                    <Text
                      style={{ fontFamily: "Poppins-Bold", fontSize: 11, color: !tempGrade ? "#1D4ED8" : "#9CA3AF" }}
                    >
                      TẤT CẢ
                    </Text>
                  </TouchableOpacity>
                  {GRADES.map((g) => (
                    ...
                    >
                      <Text
                        style={{ fontFamily: "Poppins-Bold", fontSize: 11, color: tempGrade === g ? "#1D4ED8" : "#9CA3AF" }}
                      >
                        KHỐI {g}
                      </Text>
                    </TouchableOpacity>
        ...
        <FlatList
              ...
              <View className="flex-1 ml-4">
                ...
                <View className="flex-row items-center flex-wrap gap-2">
                  <View className="bg-teal-50 px-2 py-0.5 rounded-lg border border-teal-100">
                    <Text style={{ fontFamily: "Poppins-Medium", fontSize: 10, color: "#0D9488" }}>Lớp {item.className}</Text>
                  </View>
                  <Text style={{ fontFamily: "Poppins-Medium", fontSize: 10 }} className="text-gray-400">Khối {item.grade}</Text>
                </View>
              </View>
          ...
          ListEmptyComponent={
            <View className="items-center py-20 bg-white rounded-[40px] border border-dashed border-gray-200 mx-6">
              ...
              <Text style={{ fontFamily: "Poppins-Medium" }} className="text-gray-400 mt-4 text-center px-10">Không tìm thấy học sinh nào.{"\n"}Hãy thử điều chỉnh bộ lọc.</Text>
            </View>
          }
