...
export default function AdminDashboard() {
  ...
  const adminName = userInfo?.fullName?.split(' ').at(-1) ?? 'Administrator';
  ...
  const QUICK_ACTIONS = [
    ...
    { label: 'Roles',    icon: 'shield-outline',         color: 'bg-purple-100', iconColor: '#A855F7', route: '/admin/roles' },
    { label: 'Students', icon: 'school-outline',         color: 'bg-blue-50',    iconColor: '#0ea5e9', route: '/admin/students' },
    { label: 'Teachers', icon: 'person-circle-outline',  color: 'bg-indigo-100', iconColor: '#6366F1', route: '/admin/teachers' },
    { label: 'Classes',  icon: 'business-outline',       color: 'bg-teal-100',   iconColor: '#14B8A6', route: '/admin/class-years' },
    { label: 'Subjects', icon: 'book-outline',           color: 'bg-green-100',  iconColor: '#22C55E', route: '/admin/subjects' },
    { label: 'Schedules',icon: 'calendar-outline',       color: 'bg-amber-100',  iconColor: '#D97706', route: '/admin/schedules' },
  ...
  const STAT_CARDS = [
    { label: 'Students', value: stats.students, icon: 'people', color: '#136ADA', bg: 'bg-blue-50' },
    { label: 'Teachers', value: stats.teachers, icon: 'person', color: '#A855F7', bg: 'bg-purple-50' },
    { label: 'Classes',  value: stats.classes,  icon: 'school', color: '#14B8A6', bg: 'bg-teal-50' },
    { label: 'Fees Due', value: stats.fees,     icon: 'cash',   color: '#F97316', bg: 'bg-orange-50' },
  ];
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      >
        ...
        <View className="mx-6 mb-10 p-5 bg-indigo-500 rounded-3xl overflow-hidden shadow-lg shadow-indigo-200">
           ...
           <Text style={{ fontFamily: 'Poppins-Bold' }} className="text-white text-base">Quick Report</Text>
           <Text style={{ fontFamily: 'Poppins-Regular' }} className="text-white/80 text-xs mt-1">Review all student marks and attendance for Term 1.</Text>
           <TouchableOpacity className="bg-white/20 self-start px-4 py-1.5 rounded-full mt-4">
              <Text style={{ fontFamily: 'Poppins-SemiBold' }} className="text-white text-[10px]">Generate Report</Text>
           </TouchableOpacity>
        </View>
