...
export default function AdminDashboard() {
  ...
  const QUICK_ACTIONS = [
    { label: 'Người dùng',  icon: 'people-outline',        color: 'bg-blue-100',   iconColor: '#136ADA', route: '/admin/users' },
    { label: 'Vai trò',      icon: 'shield-outline',         color: 'bg-purple-100', iconColor: '#A855F7', route: '/admin/roles' },
    { label: 'Học sinh',    icon: 'school-outline',         color: 'bg-blue-50',    iconColor: '#0ea5e9', route: '/admin/students' },
    { label: 'Giáo viên',    icon: 'person-circle-outline',  color: 'bg-indigo-100', iconColor: '#6366F1', route: '/admin/teachers' },
    { label: 'Lớp học',     icon: 'business-outline',       color: 'bg-teal-100',   iconColor: '#14B8A6', route: '/admin/class-years' },
    { label: 'Môn học',     icon: 'book-outline',           color: 'bg-green-100',  iconColor: '#22C55E', route: '/admin/subjects' },
    { label: 'Lịch học',     icon: 'calendar-outline',       color: 'bg-amber-100',  iconColor: '#D97706', route: '/admin/schedules' },
  ...
  const STAT_CARDS = [
    { label: 'Học sinh',  value: stats.students, icon: 'people', color: '#136ADA', bg: 'bg-blue-50' },
    { label: 'Giáo viên', value: stats.teachers, icon: 'person', color: '#A855F7', bg: 'bg-purple-50' },
    { label: 'Lớp học',   value: stats.classes,  icon: 'school', color: '#14B8A6', bg: 'bg-teal-50' },
    { label: 'Học phí',   value: stats.fees,     icon: 'cash',   color: '#F97316', bg: 'bg-orange-50' },
  ];
      ...
      >
        ...
        <View className="px-6 mt-6 mb-2">
          ...
          <Text style={{ fontFamily: 'Poppins-Regular' }} className="text-gray-400 text-xs">
            Bảng điều khiển cho Năm học {SCHOOL_YEAR}
          </Text>
        </View>

        {/* Stats Grid */}
        <View className="px-6 mt-6 mb-5">
          <Text style={{ fontFamily: 'Poppins-SemiBold' }} className="text-gray-500 text-xs mb-3 uppercase tracking-widest">Tổng quan chung</Text>
        ...
        <View className="px-6 mb-5">
          <Text style={{ fontFamily: 'Poppins-SemiBold' }} className="text-gray-500 text-xs mb-3 uppercase tracking-widest">Quản lý hệ thống</Text>
        ...
        <View className="mx-6 mb-10 p-5 bg-indigo-500 rounded-3xl overflow-hidden shadow-lg shadow-indigo-200">
           ...
           <Text style={{ fontFamily: 'Poppins-Bold' }} className="text-white text-base">Báo cáo nhanh</Text>
           <Text style={{ fontFamily: 'Poppins-Regular' }} className="text-white/80 text-xs mt-1">Xem xét kết quả học tập và điểm danh Học kỳ 1.</Text>
           <TouchableOpacity className="bg-white/20 self-start px-4 py-1.5 rounded-full mt-4">
              <Text style={{ fontFamily: 'Poppins-SemiBold' }} className="text-white text-[10px]">Tạo báo cáo</Text>
           </TouchableOpacity>
        </View>
