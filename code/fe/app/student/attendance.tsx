        ...
        <View className="px-6 pt-4 pb-10">
          ...
          <View className="bg-[#EAEAEA] rounded-3xl p-4 mb-6">
            ...
            <View className="flex-row justify-between mb-4 px-2">
              {DAYS_OF_WEEK.map((d, i) => (
                <Text key={i} className="text-black text-xs w-[13%] text-center" style={{ fontFamily: "Poppins-Regular" }}>
                  {d}
                </Text>
              ))}
            </View>
                  ...
                  return (
                    <View key={day} className="w-[14.28%] aspect-square items-center justify-center mb-2">
                      <View className={`w-8 h-8 items-center justify-center rounded-full ${circle}`}>
                        <Text className={`text-sm ${text}`} style={{ fontFamily: "Poppins-Medium" }}>
                          {day}
                        </Text>
                      </View>
                    </View>
          ...
          <View className="flex-row justify-center gap-5 mb-6">
            <View className="flex-row items-center">
              ...
              <Text className="text-black text-xs" style={{ fontFamily: "Poppins-Medium" }}>Present</Text>
            </View>
            <View className="flex-row items-center">
              <View className="w-3 h-3 rounded-full border border-red-500 mr-2" />
            ...
            <View className="flex-row items-center">
              ...
              <Text className="text-black text-xs" style={{ fontFamily: "Poppins-Medium" }}>Late</Text>
            </View>
          </View>
